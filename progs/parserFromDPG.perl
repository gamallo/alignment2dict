...
$Fg = "Fg_[0-9]+";
$X = "[A-Z]+_[0-9]+";
$NOMINAL = "PRO_[0-9]+$a|CONJ_[0-9]+${l}coord:noun${r}|NOUN_[0-9]+";
$NOUNCOORD = "NOUN_[0-9]+$a|CONJ_[0-9]+${l}coord:noun${r}";
$NOTVERB = "[^V]+_[0-9]+";
$PUNCT = "F[a-z]+_[0-9]+";
...
$cliticopers  = "(?:lo\|la\|los\|las\|le\|les\|nos\|os\|me\|te\|se\|Lo\|La\|Las\|Le\|Les\|Nos\|Os\|Me\|Te\|Se\|)";
...
$listTags =~ s/($ADJ${l}concord:1${r})($NOUN${l}concord:1${r})/$2/g;
...
$listTags =~ s/($NOUN${l}concord:1${r})($ADJ${l}concord:1${r})/$1/g;
$listTags =~ s/concord:[01]\|//g;
(@temp) = ($listTags =~ /($NOUN$a)($ADJ$a)/g);
$Rel =  "AdjnR";
HeadDep($Rel,"gender,number",@temp);
...
# SpecL: DET|CARD NOUN|PRO
# Recursivity: 2
(@temp) = ($listTags =~ /($DET$a|$CARD$a)($NOUN$a|$PRO$a)/g);
$Rel =  "SpecL";
DepHead($Rel,"",@temp);
$listTags =~ s/($DET$a|$CARD$a)($NOUN$a|$PRO$a)/$2/g;
(@temp) = ($listTags =~ /($DET$a|$CARD$a)($NOUN$a|$PRO$a)/g);
$Rel =  "SpecL";
DepHead($Rel,"",@temp);
$listTags =~ s/($DET$a|$CARD$a)($NOUN$a|$PRO$a)/$2/g;
...
# CprepR: NOUN [PRP] [PRO<type:P>] PRP NOUN|PRO
# NEXT
# CprepR: NOUN PRP PRO<type:P> [PRP] [NOUN|PRO]
# Recursivity:1
(@temp) = ($listTags =~ /($NOUN$a)(?:$PRP$a)(?:$PRO${l}type:P\|${r})($PRP$a)($NOUN$a|$PRO$a)/g);
$Rel =  "CprepR";
HeadRelDep($Rel,"",@temp);
(@temp) = ($listTags =~ /($NOUN$a)($PRP$a)($PRO${l}type:P\|${r})(?:$PRP$a)(?:$NOUN$a|$PRO$a)/g);
$Rel =  "CprepR";
HeadRelDep($Rel,"",@temp);
$listTags =~ s/($NOUN$a)($PRP$a)($PRO${l}type:P\|${r})($PRP$a)($NOUN$a|$PRO$a)/$1/g;
(@temp) = ($listTags =~ /($NOUN$a)(?:$PRP$a)(?:$PRO${l}type:P\|${r})($PRP$a)($NOUN$a|$PRO$a)/g);
$Rel =  "CprepR";
HeadRelDep($Rel,"",@temp);
(@temp) = ($listTags =~ /($NOUN$a)($PRP$a)($PRO${l}type:P\|${r})(?:$PRP$a)(?:$NOUN$a|$PRO$a)/g);
...
# CprepR: [NOUN]? [PRP]? [NOUN]? [PRP]? NOUN PRP NOUN
# NEXT
# CprepR: [NOUN]? [PRP]? NOUN PRP NOUN [PRP]? [NOUN]?
# NEXT
# CprepR: NOUN PRP NOUN [PRP]? [NOUN]? [PRP]? [NOUN]?
(@temp) = ($listTags =~ /(?:$NOUN$a)?(?:$PRP$a)?(?:$NOUN$a)?(?:$PRP$a)?($NOUN$a)($PRP$a)($NOUN$a)/g);
$Rel =  "CprepR";
HeadRelDep($Rel,"",@temp);
(@temp) = ($listTags =~ /(?:$NOUN$a)?(?:$PRP$a)?($NOUN$a)($PRP$a)($NOUN$a)(?:$PRP$a)?(?:$NOUN$a)?/g);
$Rel =  "CprepR";
...
$Rel =  "CprepR";
HeadRelDep($Rel,"",@temp);
$listTags =~ s/($NOUN$a)($PRP$a)($NOUN$a)($PRP$a)?($NOUN$a)?($PRP$a)?($NOUN$a)?/$1/g;
